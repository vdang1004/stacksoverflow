		...
		return (
			<form className="container" onSubmit={this.handleFormSubmit}>
				...
				<SingleInput
					...
					placeholder={'Enter a short description of your entry'} />
				<Select
					name={'ageRange'}
					placeholder={'Choose Deposit or Withdraw'}
					controlFunc={this.handleAgeRangeSelect}
					options={this.state.ageOptions}
					selectedOption={this.state.ownerAgeRangeSelection} />
				<CheckboxOrRadioGroup
					title={'What sort of money entry is this?'}
					setName={'pets'}
					type={'checkbox'}
				...
				<CheckboxOrRadioGroup
					title={'Is this a repeated entry to remember?'}
					setName={'siblings'}
				...
				<SingleInput
					...
					placeholder={'Enter money entry amount'} />
				<TextArea
					title={'Enter a longer description if the Memo line is too short'}
					rows={5}
					resize={false}
